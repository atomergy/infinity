    ...
    var imJs = {
        ...
        slickActivation:function(){
            $('.slick-activation-01').slick({
                ...
                rtl:true,
                adaptiveHeight: true,
                prevArrow: '<button class="slide-arrow prev-arrow"><i class="feather-arrow-right"></i></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><i class="feather-arrow-left"></i></button>',
                responsive: [{
                        breakpoint: 1124,
                        settings: {
                            slidesToShow: 2,
				...
				$.ajax({
					...
					success: function (data) {
						...
						if (data.code === false) {
							...
							_self.find('.rn-btn').after('<div class="error-msg bg-danger text-white rounded-3 mt-4 p-3"><p class="small text-white">*' + data.err + '</p></div>');
                            console.log(data)
						} else {
							$('.error-msg').hide();
							$('.form-group').removeClass('focused');
							_self.find('.rn-btn').after('<div class="success-msg bg-success rounded-3 mt-4 p-3"><p class="small text-white">' + data.success + '</p></div>');
